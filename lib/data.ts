...
export const MISSION = {
  ...
  pillars: [
    {
      title: "Our Mission",
      desc: "Make fresh, honest nutrition the easiest choice in your day.",
      emoji: "🎯",
    },
    {
      title: "Our Purpose",
      desc: "Replace processed snacks and sugary drinks with something real, one sip at a time.",
      emoji: "💚",
    },
    {
      title: "Our Promise",
      desc: "Freshly made, fairly priced, and delivered like clockwork six days a week.",
      emoji: "🤝",
    },
  ],
};
